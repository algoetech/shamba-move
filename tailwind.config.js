...
export default {
  ...
  theme: {
    ...
    backgroundImage: ({ theme }) => ({
      ...
      "gradient-vendor-tertiary": "linear-gradient(310deg," + theme("colors.vendor.tertiary.beta") + "," + theme("colors.vendor.tertiary.alpha") + ")",
      "gradient-vendor-secondary": "linear-gradient(277deg," + theme("colors.vendor.secondary.beta") + "," + theme("colors.vendor.secondary.alpha") + ")",
      "gradient-vendor-light-mixer": "linear-gradient(277deg," + theme("colors.vendor.secondary.alpha") + "," + theme("colors.vendor.tertiary.alpha") + ")",
      "gradient-vendor-dark-mixer": "linear-gradient(277deg," + theme("colors.vendor.secondary.beta") + "," + theme("colors.vendor.tertiary.beta") + ")",
