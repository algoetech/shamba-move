                        ...
                        <ul class="pb-2 space-y-2">
                            <li>
                                <form action="#" method="GET" class="lg:hidden">
                                    <label for="mobile-search" class="sr-only">Searchi</label>
                                    <div class="relative">
                                        <div
                            ...
                            <li>
                                ...
                                <ul id="dropdown-playground" class="py-2 space-y-2 ">
                                    <li>
                                        <a href="https://flowbite-admin-dashboard.vercel.app/playground/stacked/"
                                            class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Stacked</a>
                                    </li>
                                    <li>
                                        <a href="https://flowbite-admin-dashboard.vercel.app/playground/sidebar/"
                                            class="flex items-center p-2 text-base text-gray-900 transition duration-75 bg-gray-100 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 dark:bg-gray-700 ">Sidebar</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
