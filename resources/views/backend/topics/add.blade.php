    ...
    <div class="relative w-full max-h-full p-4 lg:max-w-[42rem] md:max-w-xl">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
              <form class="space-y-4" action="{{ route('admin.topics.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('POST')
                  <div>
                  ...
                  <button type="submit" class="w-full text-white bg-vendor-primary hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add topic</button>
              </form>
