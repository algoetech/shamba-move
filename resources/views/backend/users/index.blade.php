                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <img class="w-10 h-10 rounded-full" src="{{ '../'.$user->profile_picture }}" alt="{{ $user->name }} image">
                            <div class="ps-3">
                                <div class="text-base font-semibold text-gray-500">{{ $user->first_name??$user->name }} {{ $user->last_name }}</div>
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex flex-row gap-2 ">
                                <a href="{{route('admin.users.edit', $user->id)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline group hover:scale-110">
                                ...
                                <form action="{{route('admin.users.destroy', $user->id)}}" method="post">
                                    ...
                                    <button type="submit" class="group hover:scale-110" onclick="return confirm('Are you sure You want to do this!');">
    ...
    <x-slot name="javascript">
        <script>
            quill.on('text-change', function() {
                    ...
                    document.getElementById('bioInput').value = html;
                });
        </script>
    </x-slot>
</x-app-layout>
